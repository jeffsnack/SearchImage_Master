...
# 使用 os.path.join 來建立訓練、驗證和測試目錄路徑
...
model.add(Dense(4096,activation='relu'))  
model.add(Dropout(0.5))  
model.add(Dense(20,activation='softmax')) #Dense(預測幾種種類,activation='softmax')
...
history=model.fit_generator(
      ...
      validation_steps=12,callbacks=[TensorBoard(log_dir=r'D:\python_projects\SearchImage-master\model_pro\log3')])
model.save(r'D:\python_projects\SearchImage-master\model_pro\model\vgg16_use7.h5')
